(window.webpackJsonp = window.webpackJsonp || []).push([
    ["chart-widget-gui"], {
        "+jnJ": function(e, t, s) {
            ...
            function a(e) {
                return e === i.AlwaysOn || e === i.AlwaysOff ? e : i.VisibleOnMouseOver
            }
            ...
            function r(e, t) {
                ...
                function d() {
                    if (!s) {
                        s = Object(l.a)();
                        let i = n.getValue(e);
                        void 0 === i && void 0 !== t && (i = n.getValue(t)), s.setValue(a(i)), s.subscribe(s, t => {
                            n.setValue(e, a(t.value()))
                        })
                    }
                    return s
                }
                return {
                    ...
                    availableValues: function() {
                        return [{
                            id: i.VisibleOnMouseOver,
                            value: i.VisibleOnMouseOver,
                    ...
                    actualBehavior: function() {
                        if (!r) {
                            ...
                            const e = d(),
                                t = () => {
                                    let t = e.value();
                                    t !== i.AlwaysOn && t !== i.AlwaysOff && (t = o.mobiletouch ? i.AlwaysOn : i.VisibleOnMouseOver), r && r.setValue(t)
                                };
                            e.subscribe(r, t), t()
                        }
                        return r
        ...
        RspR: function(e, t, s) {
            ...
            const {
                ...
                availableValues: n,
                actualBehavior: a
            } = Object(i.b)("PaneButtons.visibility", o.c)
        },
        S48P: function(e, t) {
        ...
        TGRH: function(e, t, s) {
            ...
            class L {
                ...
                _initVisibility() {
                    this._visibilityTypeProperty = Object(n.a)(), this._visibilityTypeProperty.subscribe(this, this._onVisibilityTypeChange), this._onVisibilityTypeChange()
                }
                ...
                _updateBtnGroupVisibility() {
                    ...
                    for (const e of this._visibilityPrioritizedGroups) {
                        ...
                        e.available() && (!T || !e.shouldBeHiddenOnMobile) && (s -= e.totalWidth, e.enoughSpaceForGroup = s >= 0 && !i, i = i || !e.enoughSpaceForGroup), !e.enoughSpaceForGroup !== e.element.classList.contains("js-hidden") && e.element.classList.toggle("js-hidden", !e.enoughSpaceForGroup)
                    }
        ...
        lvAK: function(e, t, s) {
            ...
            class _ {
                constructor(e, t, s) {
                    ...
                    this._render(), this._updatePaneControlsWidgetVisibility(), this._updateThemedColor(this._themedColor.value()), this._parentEl.classList.toggle(u.touchMode, d.a), this._parentEl.addEventListener("contextmenu", e => e.preventDefault())
                }
                destroy() {
                ...
                _updatePaneControlsWidgetVisibility() {
                    ...
                    switch (this._visibilityType.value()) {
                        ...
                        case r.a.AlwaysOn:
                            ...
                            break;
                        case r.a.VisibleOnMouseOver:
                            e = this._globalVisibility.value() && this._mouseOverWidget
                    }
                    this._parentEl.classList.toggle(u.hidden, !e), this._parentEl.classList.toggle(u.forceHidden, !this._globalVisibility.value() || t)
                }
            ...
            function y(e, t) {
                ...
                return function(e) {
                    ...
                    return b.ContextMenuManager.createMenu(t)
                }(e).then(e => (e.show(e => {
            ...
            const L = i.mobiletouch,
                D = window.t("Delete pane"),
                H = window.t("Move pane up"),
                B = window.t("Move pane down"),
            ...
            class R {
                ...
                updateThemedColors(e) {
                    null === e && (e = Object(E.getStdThemedValue)("chartProperties.paneProperties.background", this._backgroundThemeName.value())), this._themedColor.setValue(e || "")
                }
                _updateButtonsVisibility() {
                    this._closeButtonVisibility.setValue(this._getCloseButtonVisibility()), this._upButtonVisibility.setValue(this._getUpButtonVisibility()),
                        this._downButtonVisibility.setValue(this._getDownButtonVisibility()), this._maximizeButtonVisibility.setValue(this._getMaximizeButtonVisibility()), this._minimizeButtonVisibility.setValue(this._getMinimizeButtonVisibility())
                }
                _createActions() {
                    this._actions.up = {
                        iconMap: new Map([
                ...
                _getCloseButtonVisibility() {
                    ...
                    let t = !1;
                    return e.containsMainSeries() || e.isMaximized() || L || (t = e.dataSources().some(e => Object(l.isStudy)(e))), t
                }
                _onCloseButton() {
                ...
                _getUpButtonVisibility() {
                    const e = this._paneWidget.state();
                    return this._model.model().panes().indexOf(e) > 0 && !e.isMaximized() && !L
                }
                ...
                _getMaximizeButtonVisibility() {
                    const e = this._paneWidget.state();
                    return this._model.model().panes().length > 1 && !e.isMaximized() && !L
                }
                ...
                _showButtonsInContextMenu(e) {
                    e.preventDefault(), null !== this._moreActionCM && this._moreActionCM.isShown() ? this._moreActionCM = null : y(this._actions, e).then(e => {
        ...
        sAH5: function(e, t, s) {
            ...
            class g extends class {
                ...
                toggleVisibility(e) {
                    this._loadingEl.classList.toggle(b.blockHidden, !e)
                }
                _renderLoading(e) {
                    const {
                        className: t
                ...
                _renderLoading(e) {
                    super._renderLoading(e), this._loadingEl.innerHTML = `\n\t\t\t<span class="${m.loaderItem}"></span>\n\t\t\t<span class="${m.loaderItem}"></span>\n\t\t\t<span class="${m.loaderItem}"></span>\n\t\t`, this._loadingEl.classList.add(m.loader)
                }
            }
            var w = s("qFKp");
            ...
            const S = w.CheckMobile.any(),
                f = [y.title1st, y.title2nd, y.title3rd, y.title4th];
            class M {
                constructor(e, t, s) {
                ...
                _renderTitle() {
                    ...
                    for (let t = 0; t < this._titlesSpawns.length; t++) {
                        ...
                        s.classList.add(y.title, f[t], "apply-overflow-tooltip"), s.dataset.name = "legend-source-title";
                        const i = this._titlesSpawns[t].value();
                        i.length > 0 ? (s.appendChild(document.createTextNode(i)), s.classList.add(y.withDot)) : s.classList.add(b.blockHidden), e.appendChild(s), this._titleElements.push(s)
                    }
                }
                _renderActions() {
                    ...
                    for (const s of this._model.actions()) {
                        const i = Object(c.a)(s, y.button, y.buttonIcon, b.blockHidden, t);
                        e.appendChild(i)
                    }
                }
                _isWidthButtonsMode() {
                ...
                _updateTitlesHandler(e, t) {
                    const s = Object(i.ensureNotNull)(this._titleElements[e]),
                        o = 0 === t.length;
                    s.classList.toggle(b.blockHidden, o), s.classList.toggle(y.withDot, !o), v(s, t)
                }
                _updateStates(e) {
                ...
                _updateValueVisibleHandler(e, t) {
                    ...
                    null !== s && s.classList.toggle(b.blockHidden, !t)
                }
                _updateShowLine() {
                    null !== this._el && this._el.classList.toggle(b.blockHidden, this._isRowHidden.value())
                }
                _createValuesSpawns() {
                ...
                _updateShowValues() {
                    null !== this._valuesAdditionalWrapperEl && this._valuesAdditionalWrapperEl.classList.toggle(b.blockHidden, this._isValuesShouldBeHidden())
                }
                ...
                _updateShowTitles() {
                    null !== this._titleParentEl && (this._titleParentEl.classList.toggle(b.blockHidden, this._isTitleHidden.value()), null !== this._actionsParentEl && this._actionsParentEl.classList.toggle(b.blockHidden, this._isTitleHidden.value()))
                }
                _updateValues() {
                ...
                _updateActionVisibilities(e) {
                    null !== this._actionsParentEl && this._actionsParentEl.querySelectorAll("." + y.button)[e].classList.toggle(b.blockHidden, !this._actionsSpawnArray[e].visible.value())
                }
                ...
                _updateStatusWidgetVisibility(e) {
                    null !== this._statusesWrapper && this._statusesWrapper.classList.toggle(b.blockHidden, e)
                }
            }
            class E extends M {
                constructor(e, t, s) {
                ...
                _renderValues() {
                    ...
                    for (const s of t) {
                        ...
                        t.classList.add(y.valueItem), t.classList.toggle(b.blockHidden, !s.visible.value());
                        const i = document.createElement("div"),
                            o = s.title.value() || "";
                        i.classList.add(y.valueTitle), i.classList.toggle(b.blockHidden, 0 === o.length), i.appendChild(document.createTextNode(o)), t.appendChild(i);
                ...
                _updateValuesTitleHTMLElHandler(e, t = "") {
                    ...
                    v(s, t), s.classList.toggle(b.blockHidden, 0 === t.length), this._updateShowValues()
                }
                _isWidthButtonsMode() {
            ...
            class k extends M {
                ...
                _updateShowLine() {
                    ...
                    e ? this._el.classList.toggle(b.blockHidden, e) : super._updateShowLine()
                }
                _getButtonsCount() {
                    switch (this._mode) {
                        case 4:
            ...
            var O = s("6dGu"),
                ...
                T = s("Y+EN"),
                A = s("vYP1");
            const L = window.t("Hide Indicator Legend"),
            ...
            class B {
                ...
                _render() {
                    this._el = document.createElement("div"), this._el.className = y.toggler + " apply-common-tooltip", this._arrowIconEL = document.createElement("div"), this._arrowIconEL.classList.add(y.iconArrow), this._arrowIconEL.innerHTML = h.a ? W : O, this._el.appendChild(this._arrowIconEL), this._objectTreeEl = document.createElement("div"), this._objectTreeEl.classList.add(y.objectTree), this._objectTreeEl.innerHTML = h.a ? A : T, this._el.appendChild(this._objectTreeEl), this._counterEl = document.createElement("div"), this._counterEl.classList.add(y.counter), this._counterEl.appendChild(document.createTextNode(String(this._sourceCount.value()))), this._el.appendChild(this._counterEl), this._parentEl.appendChild(this._el)
                }
                _updateThemedColor(e) {
                    if (null !== this._el)
                        if (e.length > 0) {
                ...
                _updateSourceCount(e) {
                    v(Object(i.ensureNotNull)(this._counterEl), String(e)); {
                        const t = Object(i.ensureNotNull)(this._el),
                            s = e < 1;
                        t.classList.toggle(b.blockHidden, s);
                        const o = 1 === e;
                ...
                _updateCounterVisibility(e) {
                    ...
                    const t = 1 === e;
                    this._counterEl.classList.toggle(b.blockHidden, t)
                }
                _updateState() {
                ...
                _tooltip() {
                    return 1 === this._mode ? H : this._isStateOpen.value() ? L : D
                }
                _updateTooltip() {
            ...
            class R {
                ...
                addDataSources(e, t) {
                    ...
                    for (let i = 0; i < e.length; i++) {
                        ...
                        this._dataSourceRenderers.push(l), this._updateLegendVisibility(), o.onDestroy().subscribe(this, () => {
                            const e = this._dataSourceRenderers.indexOf(l); - 1 !== e && (this._dataSourceRenderers[e].destroy(), this._dataSourceRenderers.splice(e, 1))
                        }, !0)
                    }
                }
                addCustomWidget(e, t) {
                ...
                _addOutsideEventForHideTooltip() {
                    null !== this._outsideEventForCollapsedTooltip && this._outsideEventForCollapsedTooltip(), this._outsideEventForCollapsedTooltip = Object(j.a)(new CustomEvent("timestamp").timeStamp, this._collapsedDataSourcesWrapperEl, () => {
                ...
                _updateCollapsedSourcesCount(e) {
                    ...
                    const t = 0 === e;
                    this._collapsedDataSourcesWrapperEl.classList.toggle(b.blockHidden, t), t || (v(this._collapsedDataSourcesEl, "+" + e), this._collapsedDataSourcesEl.setAttribute("title", this._options.collapsedDataSourcesTitle.value()))
                }
                _updateLegendVisibility() {
                    this._parentEl.classList.toggle(b.blockHidden, this._isAllLegendHidden.value()), null !== this._dataSourcesEl && this._dataSourcesEl.classList.toggle(b.blockHidden, this._isStudiesLegendHidden.value())
                }
                _setCustomBg() {
            ...
            class Q {
                ...
                onToggleDisabled() {
                    const e = this._source.properties().childs().visible,
                        t = !e.value();
                    this._model.setProperty(e, t, `${t?"Show":"Hide"} ${this._source.title()}`), x((t ? "Show" : "Hide") + " source")
                }
                onShowSettings() {
            ...
            const ve = window.t("Settings"),
                ...
                Se = window.t("Remove"),
                fe = window.t("More"),
                Me = (window.t("Error"), window.t("Could not get Pine source code."), d.enabled("study_buttons_in_legend"), d.enabled("show_hide_button_in_legend")),
            ...
            function De(e, t, s, i, o, l) {
                return function(e, t, s, i, o) {
                    ...
                    l.push(new xe.Action({
                        ...
                        onExecute: () => Le(e, a.showSeriesTitle, "Change Symbol Description Visibility")
                    })), t.showOpenMarketStatus && l.push(new xe.Action({
                        checkable: !0,
                        checked: We.b.value(),
                        label: Be,
                        statName: "Show Open market status",
                        onExecute: () => Le(e, We.b, "Change open market status visibility")
                    }));
                    if (l.push(new xe.Action({
                            ...
                            onExecute: () => Le(e, a.showSeriesOHLC, "Change OHLC Values Visibility")
                        })), l.push(new xe.Action({
                            checkable: !0,
                            checked: a.showBarChange.value(),
                            label: je,
                            statName: "Show Bar Change Values",
                            onExecute: () => Le(e, a.showBarChange, "Change Bar Change Visibility")
                    ...
                    if (l.push(new xe.Action({
                            ...
                            onExecute: () => Le(e, a.showStudyTitles, "Change Indicator Titles Visibility")
                        })), l.push(new xe.Action({
                            checkable: !0,
                            checked: a.showStudyArguments.value(),
                            label: Ne,
                            statName: "Show Indicator Arguments",
                            onExecute: () => Le(e, a.showStudyArguments, "Change Indicator Arguments Visibility")
                        })), l.push(new xe.Action({
                            checkable: !0,
                            checked: a.showStudyValues.value(),
                            label: Ie,
                            statName: "Show Indicator Values",
                            onExecute: () => Le(e, a.showStudyValues, "Change Indicator Values Visibility")
                        })), void 0 !== r) {
                        const e = r.get(0);
                        void 0 !== e && e.length > 0 && (l.push(...e), l.push(new xe.Separator))
                    }
                    ...
                    t.settings && (l.push(new xe.Separator), l.push(new xe.Action({
                        label: Object(Te.appendEllipsis)(window.t("Settings")),
                        icon: Ae,
                        statName: "Settings...",
                        onExecute: () => s(G.TabNames.legend)
                    })));
                    return Oe.ContextMenuManager.createMenu(l, {}, o)
                }(e, t, s, i, l).then(e => (e.show(o), e))
            }
            const He = window.t("Show Symbol"),
                Be = window.t("Show Open market status"),
                Pe = window.t("Show OHLC Values"),
                je = window.t("Show Bar Change Values"),
                ze = window.t("Show Indicator Titles"),
            ...
            function lt(e) {
                const t = e.start(),
                    ...
                    l = tt(t),
                    n = tt(t + s);
                return s > Ze.minutesPerDay ? `${Ye.weekDaysShortNames[i]} ${l} — ${Ye.weekDaysShortNames[o]} ${n}` : `${l} — ${n}`
            }

            function nt(e, t, s, i) {
                return Math.abs(i - s) > 1 ? `${Ye.weekDaysShortNames[s]} ${e.title} — ${Ye.weekDaysShortNames[i]} ${t.title}` : `${e.title} — ${t.title}`
            }
            ...
            class rt {
                    ...
                    Object.values(a).some(e => 0 !== e.entries.length) && (function(e) {
                        ...
                        for (const l of Object.keys(e)) {
                            ...
                            for (let e = 0; e < p; e++) {
                                ...
                                a.splice(b, 0, d), b = e + 2
                            }
                            const m = a[a.length - 1];
                            1 !== m.end.value && a.push({
                                start: {
                                    value: m.end.value,
                                    title: m.end.title,
                                    isFirstOrLastPoint: !0
                                ...
                                type: 3,
                                tooltip: nt(m.end, _.entries[0].start, n, _.dayIndex),
                                showStartForLastEntry: !1,
                                showEndForFirstEntry: !1
                            })
                        }
                ...
                _createSubSessionSpecs(e) {
                    ...
                    if (void 0 === e.subsessions) return new Map([
                        [0, new $e.SessionSpec(e.timezone, e.session, e.session_holidays, e.corrections)]
                    ]);
            ...
            function gt(e) {
                return mt.has(e) || mt.set(e, Object(pt.randomHash)()), Object(i.ensureDefined)(mt.get(e))
            }
            const wt = new Map([
                    [0, bt.green],
                    [1, bt.orange],
            ...
            function yt(e) {
                ...
                }, a = ut(bt.segment, wt.get(t.type), (s || t.start.isFirstOrLastPoint) && bt.start, (i || t.end.isFirstOrLastPoint) && bt.end, l && bt.small, "common-tooltip-html", "apply-common-tooltip"), r = function(e, t) {
                    return `<div class="${bt.tooltip}">\n\t\t<span class="${wt.get(t)}">${vt.get(t)}</span>\n\t\t<span class="${bt.time}">${e}</span>\n\t</div>`
                }(t.tooltip, t.type);
            ...
            function St(e) {
                ...
                })), i = ut(bt.sessionDay, t.isActive && bt.active);
                return ht.a.createElement("div", {
                    className: i
                }, ht.a.createElement("div", {
                    className: bt.weekDay
                }, t.title), ht.a.createElement("div", {
                    className: bt.sessionDaySegments
                }, s))
            }
            ...
            function ft(e) {
                const {
                    sessionDays: t,
                    currentTimeMark: s
                } = e, i = [], o = parseInt(Object.keys(t).filter(e => t[parseInt(e)].isActive)[0]), l = t[o], n = l.entries.filter(e => e.start.value <= s && e.end.value >= s)[0];
                ...
                const r = i.map(e => ht.a.createElement("div", {
                        key: gt(e),
                        className: bt.timeMark
                    }, e.title)),
                    d = 100 * (2 === i.length ? i[1].value - i[0].value : 0),
                    h = ut(d > 12 && bt.timeMarkSegmentAlignByEnds, bt.timeMarkSegment);
                return ht.a.createElement("div", {
                    className: bt.sessionDay
                }, ht.a.createElement("div", {
                    className: bt.weekDay
                }), ht.a.createElement("div", {
                    className: bt.timeMarkWrapper
                }, ht.a.createElement("div", {
                    className: h,
                    style: {
                        left: 100 * i[0].value + "%",
            ...
            class Mt {
                ...
                renderer(e, t) {
                    return function(e) {
                        ...
                        }), n = Object.values(l).filter(e => e.isActive)[0], a = ut(s, bt.wrapper);
                        return ht.a.createElement("div", {
                            key: t,
                            className: a
                        }, ht.a.createElement("div", {
                            className: bt.timezone
                        }, o), ht.a.createElement("div", {
                            className: bt.sessionDayWrapper
                        }, ht.a.createElement(St, {
                            sessionDay: n
                        }), ht.a.createElement("div", {
                            className: bt.nowWrapper
                        }, ht.a.createElement("div", {
                            className: bt.now,
                            style: {
                                left: 100 * i + "%"
                            }
                        }))), ht.a.createElement(ft, {
                            sessionDays: l,
                            currentTimeMark: i
                        }))
                    }({
            ...
            function Tt() {
                return Ot.getJSON("tv.alreadyBlinkedStatuses", Wt)
            }
            const At = new l.a(Tt());

            function Lt(e) {
                const t = Ot.getJSON("tv.alreadyBlinkedStatuses", Wt);
                t.includes(e) || (t.push(e), Ot.setJSON("tv.alreadyBlinkedStatuses", t), At.setValue(Tt()))
            }
            Ot.onSync.subscribe(null, () => At.setValue(Tt()));
            const Dt = At;
            var Ht = s("Cf1E"),
                Bt = s("VrrN"),
                Pt = s("VrXG"),
            ...
            class hs extends xt {
                ...
                async _getHtmls() {
                    ...
                    for (const l of e)
                        if (t[l] = [], ["DelayToRealtime", "DelayNoRealtime", "DelayWithoutMarketAgreement", ...Ft].includes(l) && (t[l].push(Jt.format({
                                symbolName: s,
            ...
            var Vs = s("YGQl"),
                xs = s("Jjb7");
            const Os = window.t("Invalid Symbol"),
                Ws = window.t("This symbol doesn't exist, please pick another one."),
                Ts = new Map([
                    [!0, new Map([
                        ["small", Vs],
                        ["large", xs]
            ...
            class zs {
                ...
                addStatusModel(e) {
                    this._iconsRenderers.push(new js({
                        visible: e.visible,
                        icon: e.model.icon(),
            ...
            class _i {
                constructor(e, t, s) {
                    this.visibleWidgetsCount = new l.a(0), this.errorWidgetIsShown = new l.a(!1), this._size = h.a ? "large" : "small", this._tooltips = new l.a([]), this._visibilitySpawns = [], this._tooltipSpawns = [], this._statusWidgetInfos = [], this._renderer = new zs(this._size, this.visibleWidgetsCount, this._tooltips, {
                ...
                _recreateWidgets() {
                    ...
                    if (this._options.marketStatusEnabled) {
                        ...
                        if (null === this._marketStatusViewModel) {
                            ...
                            null !== e && (this._sessionWidget = new Mt(this._source), s.additionalWidgets = [this._sessionWidget]), this._statusWidgetInfos.push(s), this._renderer.addStatusModel(s)
                ...
                _updateDropdownMenu() {
                    Promise.all([s.e("react"), s.e(6), s.e(11), s.e(93), s.e(0), s.e(5), s.e("full-tooltips-popup")]).then(s.bind(null, "vR7+")).then(e => {
            ...
            const bi = window.t("Replay mode"),
                mi = window.t("You're in Replay mode. You're in Replay mode. You're in Replay mode.");
            new Map([
                [!0, new Map([
                    ["small", pi],
                    ["large", pi]
            ...
            const yi = {
                ...
                fi = d.enabled("legend_context_menu"),
                Mi = 2 * parseInt(y.marginlegendhoriz);
            class Ei {
                ...
                onShowLegendWidgetContextMenu(e, t) {
                    if (this._options.readOnlyMode || !fi) return Promise.resolve(null);
                ...
                updateLayout() {
                    ...
                    if (0 === n)
                        for (let t = e.length - 1; t >= 0; t--) o.push(new Ve(this._model, e[t], this._dataSourceViewModelsOptions, this._callbacks, this._options.contextMenu)), l.push(new _i(e[t], this._model.model(), this._options.statusesWidgets));
                    else {
                        let t = 0;
                ...
                addMargin(e) {
                    ...
                    this._margin = e;
                    this._renderer.getElement().style.maxWidth = 0 === this._margin ? "" : `calc(100% - ${this._margin+Mi}px)`, this._updateWidgetModeBySize()
                }
                ...
                _availableWidth() {
                    return null === this._size ? 0 : this._size.w - this._margin - Mi
                }
            }
        },
        tfDh: function(e, t, s) {
