        ...
        "4Cm8": function(t, e, s) {
            ...
            const R = function(t = b, e = m, s = f, l = w) {
                ...
                return (u = class extends i.PureComponent {
                    ...
                    currentPosition() {
                        return this._scroll.current ? Object(c.isRtl)() ? Object(c.getLTRScrollLeft)(this._scroll.current) : this._scroll.current.scrollLeft : 0
                    }
                    isAtLeft() {
                        return !this._isOverflowed() || this.currentPosition() <= Object(n.ensureDefined)(this.props.hideButtonsFrom)
                    }
                    isAtRight() {
                        return !this._isOverflowed() || this.currentPosition() + this.state.widthWrap >= this.state.widthContent - Object(n.ensureDefined)(this.props.hideButtonsFrom)
                    }
                    animateTo(t, e = h.b) {
                        const s = this._scroll.current;
                        s && (Object(c.isRtl)() && (t = Object(c.getLTRScrollLeftOffset)(s, t)), e <= 0 ? s.scrollLeft = Math.round(t) : Object(a.doAnimate)({
                            onStep(t, e) {
