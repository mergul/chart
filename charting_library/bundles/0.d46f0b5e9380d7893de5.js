    ...
    [0], {
        ...
        "0YpW": function(t, e, n) {
            ...
            function u(t) {
                const {
                    body: e
                } = document, n = e.querySelector(".widgetbar-wrap");
                if (t && 1 == ++c) {
                    const t = r(e, "overflow"),
                        c = s(e, "padding-right");
                    "hidden" !== t.toLowerCase() && e.scrollHeight > e.offsetHeight && (o(n, "right", i() + "px"), e.style.paddingRight = c + i() + "px", d = !0), e.classList.add("i-no-scroll")
        ...
        "8Rai": function(t, e, n) {
            ...
            function r(t) {
                ...
                } = t, l = Object(i.useRef)(null), a = Object(i.useRef)(new CustomEvent("timestamp").timeStamp);
