(window.webpackJsonp = window.webpackJsonp || []).push([
    ["floating-toolbars"], {
        ...
        "0ZwQ": function(t, e, i) {
            ...
            class C {
                constructor(t) {
                    this._widget = document.createElement("div"), this._isVertical = !1,
                        this._hiddingTimeoutId = null, this._visibility = new c.a(!1), this._windowResizeListener = this._onWindowResize.bind(this), this._reorderedDelegate = new a.a, this._responsiveResizeFunction = null, this._showTimeStamp = null, this._draggable = null, this._preventClickUntilAnimation = t => {
                ...
                addWidget(t, e = {}) {
                    ...
                    if (void 0 === e.index && (e.index = i), e.index < 0 || e.index > i) throw new Error(`Index must be in [0, ${i}]`);
                    ...
                    this._content.insertBefore(o, n),
        ...
        IhRv: function(t, e, i) {
            ...
            function b(t) {
                const {
                    ...
                    title: b,
                    className: v
                } = t, w = Object(_.a)(e), f = Object(o.useRef)(null), y = w ? Object(c.parseRgba)(w)[3] : void 0, C = "" === w, x = String(T()).toLowerCase() === p.c, [W, P, S] = Object(h.a)();
        ...
        Ve4Q: function(t, e, i) {
            ...
            function W(t) {
                const {
                    ...
                    isDrawingFinished: s,
                    activeChartWidget: r
                } = t, a = r.hasModel() && r.model().selection().dataSources();
                return a && a.length ? n.a.createElement(f.a, {
                    ...
                    isSmallWidth: t,
                    isSmallHeight: e
                }) => n.a.createElement(n.a.Fragment, null, l(), s && n.a.createElement(n.a.Fragment, null, Boolean(i.length) && i.map((i, o) => n.a.createElement(i.component, { ...i.props,
                    key: `${i.props.title}_${o}`,
                    className: x,
                    isSmallScreen: t || e
                })), Boolean(o.length) && o.map((i, o) => {
                    const s = t || e;
                    return s ? i.showForSmallScreen ? n.a.createElement(i.component, { ...i.props,
                        isSmallScreen: s,
                        key: `${i.props.title}_${o}`,
                        className: x
                    }) : null : n.a.createElement(i.component, { ...i.props,
                        key: `${i.props.title}_${o}`,
                        className: x
                    })
                })))) : l();
                ...
                function l() {
                    return null === e ? null : n.a.createElement(e.component, { ...e.props,
                        isDrawingFinished: s,
                        className: x
                    })
                }
            ...
            function R(t) {
                const {
                    activeChartWidget: e,
                    className: i
                } = t, o = e.model().selection().lineDataSources()[0].properties().frozen, s = Object(E.a)(o), r = s ? {
            ...
            function X(t) {
                const {
                    ...
                    isSmallScreen: r,
                    className: l
                } = t, c = s.model(), d = c.selection().lineDataSources(), [h, u] = Object(o.useState)([]), p = Object(o.useRef)(null), g = Object(o.useMemo)(() => new K.ActionsProvider(s), [s]);
            ...
            function nt(t) {
                const {
                    ...
                    title: s,
                    className: r
                } = t, l = Object(E.a)(e), c = Object(o.useMemo)(() => [new G.Action({
                    icon: et,
            ...
            function at(t) {
                const {
                    ...
                    title: o,
                    className: s
                } = t, r = Object(E.a)(e), a = rt.map(t => new G.Action({
                    label: t.toString(),
            ...
            class dt extends y.b {
                ...
                addGroupedWidget(t, e = {}) {
                    Object(_.assert)(t.states.length > 0 && -1 !== dt._getStateIndexById(t, t.currentStateId), `Argument is invalid (count: ${t.states.length}, state: ${t.currentStateId})`);
                ...
                setGroupedWidgetState(t, e) {
                    const i = this._ensuredGetWidgetDataForId(t);
                    Object(_.assert)(-1 !== dt._getStateIndexById(i.statedWidget, e), `Unknown stateId (${e})`), i.statedWidget.currentStateId = e, this._updateSubWidgetsState(i.statedWidget), this._updateWidgetPreview(i)
                }
                ...
                _updatePopupPosition() {
                    ...
                    if (this.isVertical()) s.classList.remove("tv-grouped-floating-toolbar__popup--at-top"), s.style.top = o.top - e.top + 1 + "px", s.style.left = "", e.left > window.innerWidth - e.right ? s.classList.add("tv-grouped-floating-toolbar__popup--at-left") : s.classList.remove("tv-grouped-floating-toolbar__popup--at-left");
                    else {
            ...
            class pt {
                constructor(t) {
                    this._isDrawingFinished = new d.a(!0), this._currentTool = null, this._updateVisibilityTimeout = null, this._lineWidthsProperty = null, this._lineColorsProperty = null,
                        this._currentProperties = null, this._container = null, this._toolbarRendered = !1, this._templatesButton = null, this._propertyButtons = [], this._commonButtons = [], this._handleSourceEdit = t => {
        ...
        gmn6: function(t, e, i) {
            ...
            class g extends o.b {
                ...
                _createLinetoolWidget(t) {
                    const e = `<span class="tv-favorited-drawings-toolbar__widget ${t===c.tool.value()?"i-active":""}" title="${d.a[t].localizedName}">${d.a[t].icon}</span>`,
                        i = Object(r.b)(e);
        ...
        myiL: function(t, e, i) {
            ...
            function f(t) {
                const {
                    ...
                    className: h,
                    isSmallScreen: u
                } = t, p = Object(c.a)(Object(r.ensureDefined)(e)), g = "mixed" === p || !p, _ = function(t) {
        ...
        rzV7: function(t, e, i) {
            ...
            t.exports = function(t, e) {
                ...
                for (var r = 0; r < i.length; r++)
                    if (!o.call(e, i[r]) || !n(t[i[r]], e[i[r]])) return !1;
                return !0
            }
        },
        tPkB: function(t, e, i) {
            ...
            class g extends s {
                ...
                onToolChanged(t, e) {
                    ...
                    this._isDrawingToolExcludingTweet(t) ? (this._isDrawingFinished.setValue(!1), this._updateVisibility()) : i && i.length ? (i.length > 1 && this._isDrawingFinished.setValue(!0),
                        this.onSourceChanged(this.selectedSources())) : this.hide()
                }
