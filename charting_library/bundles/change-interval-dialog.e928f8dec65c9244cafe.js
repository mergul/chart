    ...
    ["change-interval-dialog"], {
        ...
        R5JZ: function(e, t, n) {
            ...
            function r(e, t, n, r, i) {
                ...
                return i.click && r.addEventListener("click", o, !1), i.mouseDown && r.addEventListener("mousedown", o, !1), i.touchEnd && r.addEventListener("touchend", o, !1), i.touchStart && r.addEventListener("touchstart", o, !1), () => {
        ...
        iT0o: function(e, t, n) {
            ...
            var r = n("q1tI"),
                ...
                p = n("Iivm"),
                v = n("xJ0h");
            const g = Object(c.t)("Type the interval number for minute charts (i.e. 5 if it is going to be a five minute chart). Or number plus letter for H (Hourly), D (Daily), W (Weekly), M (Monthly) intervals (i.e. D or 2H)"),
                h = Object(c.t)("Type the interval number for minute charts (i.e. 5 if it's going to be a five minute chart). Or number plus letter for other intervals: S for 1 second chart (15S for 15 second chart, etc.), H (Hourly), D (Daily), W (Weekly), M (Monthly) intervals (i.e. D or 2H)");
            ...
            function j(e) {
                const {
                    ...
                    selectOnInit: n,
                    onClose: o
                } = e, a = Object(r.useRef)(null), [l, p] = Object(r.useState)(t.toUpperCase()), v = Object(r.useMemo)(() => Object(O.d)(l), [l]), g = function(e, t) {
                    return Object(r.useMemo)(() => {
                        ...
                        } else "S" === r ? t.qty > Object(w.getMaxResolutionValue)("S") && (n = !1) : "T" === r && 1 !== t.qty && (n = !1);
                        return n
                    }, [e, t])
                }(l, v), h = Object(r.useMemo)(() => {
                    if (!g) return null;
                ...
                return Object(r.useLayoutEffect)(() => {
                    var e, t;
                    n ? null === (e = a.current) || void 0 === e || e.select() : null === (t = a.current) || void 0 === t || t.focus()
                    ...
                    className: y.title
                }, Object(c.t)("Change interval")), i.a.createElement(b, {
                    className: y.infoHint,
                    isSecondsEnabled: Object(w.isSecondsEnabled)()
                    ...
                    className: s()(y.hint, y.error)
                }, Object(c.t)("Not applicable"))))
            }
            var C = n("Gtzb");
