    ...
    [38], {
        ...
        "82wv": function(t, e, o) {
            ...
            class h extends r.PureComponent {
                constructor(t) {
                    super(t), this._wrapperRef = null, this._controller = r.createRef(), this._handleWrapperRef = t => {
                        ...
                        const {
                            ...
                            isOpened: r
                        } = this.state, n = "boolean" == typeof t ? t : !r;
                        this.setState({
                            isOpened: n
                        }), n && o && o(), !n && e && e()
                    }, this._handleClose = () => {
                ...
                render() {
                    ...
                    return r.createElement("div", {
                        ...
                        dropped: v
                    }))), this.state.isOpened && (f ? r.createElement(u.a, {
                        rule: f
                    }, t => this._renderContent(t)) : this._renderContent(c)))
                }
                close() {
                ...
                _renderContent(t) {
                    ...
                    }, m = Boolean(p && t && a), f = function(t) {
                        return "function" == typeof t
                    }(u) ? u({
                        isDrawer: m
                    }) : u;
                    return m ? r.createElement(c.b, null, r.createElement(l.a, {
            ...
            function l(t, e) {
                return (o, l) => {
                    const d = Object(a.ensureNotNull)(t).getBoundingClientRect(),
                        ...
                        O = {
                            x: D - (m === s.FromRightToLeft ? o : 0) + f,
                            y: g - (p === i.FromBottomToTop ? l : 0) + b
                        };
        ...
        R5JZ: function(t, e, o) {
            ...
            function r(t, e, o, r, n) {
                ...
                return n.click && r.addEventListener("click", i, !1), n.mouseDown && r.addEventListener("mousedown", i, !1), n.touchEnd && r.addEventListener("touchend", i, !1), n.touchStart && r.addEventListener("touchstart", i, !1), () => {
        ...
        Sn4D: function(t, e, o) {
            ...
            function m(t) {
                const {
                    ...
                    className: f,
                    theme: v = h
                } = t, w = Object(i.ensureNotNull)(Object(r.useContext)(d.a)), [b, D] = Object(r.useState)(0), g = Object(r.useRef)(null), O = Object(r.useContext)(p.a);
                return Object(r.useEffect)(() => {
                    const t = Object(i.ensureNotNull)(g.current);
                    return t.focus({
                        preventScroll: !0
                    }), O.subscribe(w, o), Object(c.a)(!0), u.CheckMobile.iOS() && Object(a.disableBodyScroll)(t), D(w.addDrawer()), () => {
                        O.unsubscribe(w, o);
                        const e = w.removeDrawer();
                        u.CheckMobile.iOS() && Object(a.enableBodyScroll)(t), 0 === e && Object(c.a)(!1)
                    }
                }, []), n.a.createElement(l.a, null, n.a.createElement("div", {
                    className: s(h.wrap, h["position" + e])
                }, b === w.currentDrawer && n.a.createElement("div", {
        ...
        mkWe: function(t, e, o) {
            ...
            class i extends n.a.PureComponent {
                ...
                render() {
                    return n.a.createElement(s.Provider, {
                        value: {
            ...
            const a = s,
                c = r.forwardRef((t, e) => {
                    const {
                        ...
                        "data-name": D,
                        ...g
                    } = t, O = n(w, v.button, f && "apply-common-tooltip", {
                        [v.isActive]: a,
                        [v.isOpened]: c,
                        ...
                        [v.isGrouped]: d,
                        [v.hover]: u
                    }), E = o && ("string" == typeof o ? r.createElement(i.a, {
                        className: v.icon,
                        icon: o
                    }) : r.cloneElement(o, {
                    ...
                    return r.createElement("div", { ...g,
                        ...
                        title: f,
                        "data-name": D
                    }, m && h && r.createElement("div", {
                        className: n("js-button-text", v.text)
                    }, h), E, !m && h && r.createElement("div", {
                        className: n("js-button-text", v.text)
                    }, h))
                })
        }
