(window.webpackJsonp = window.webpackJsonp || []).push([
    [52], {
        ...
        "4rU7": function(o, e, l) {
            ...
            function s(o) {
                ...
                return i.createElement("div", {
                    ...
                    className: z.bg
                }, T && ("string" == typeof T ? i.createElement(a.a, {
                    className: z.icon,
                    icon: T
        ...
        "MP+M": function(o, e, l) {
            ...
            const r = {
                    keys: ["Shift"],
                    text: Object(i.t)("{hotKey_0} — drawing a straight line at angles of 45")
                },
                T = {
                    keys: ["Shift"],
                    text: Object(i.t)("{hotKey_0} — circle")
                },
                d = {
                    keys: ["Shift"],
                    text: Object(i.t)("{hotKey_0} — square")
                },
                L = {
                    ...
                    LineToolGannSquare: {
                        ...
                        hotKey: Object(a.b)({
                            keys: ["Shift"],
                            text: Object(i.t)("{hotKey_0} — fixed increments")
                        })
                    },
                    ...
                    SyncDrawing: {
                        ...
                        localizedName: Object(i.t)("New drawings are replicated to all charts in the layout and shown when the same ticker is selected")
                    },
                    arrow: {
                        icon: c.a.arrow,
                        localizedName: Object(i.t)("Arrow")
                    },
                    cursor: {
                        icon: c.a.cursor,
                        localizedName: Object(i.t)("Cross")
                    },
                    dot: {
                        icon: c.a.dot,
                        localizedName: Object(i.t)("Dot")
                    },
                    drawginmode: {
                    ...
                    eraser: {
                        icon: c.a.eraser,
                        localizedName: Object(i.t)("Eraser")
                    },
                    group: {
                        icon: c.a.group,
                        localizedName: Object(i.t)("Show Hidden Tools")
                    },
                    hideAllDrawings: {
                    ...
                    measure: {
                        ...
                        hotKey: Object(a.b)({
                            keys: ["Shift"],
                            text: Object(i.t)("{hotKey_0} + Click on the chart")
                        })
                    },
                    removeAllDrawingTools: {
                        icon: c.a.removeAllDrawingTools,
                        localizedName: Object(i.t)("Remove Drawings")
                    },
                    showObjectsTree: {
                        icon: c.a.showObjectTree,
                        localizedName: Object(i.t)("Show Object Tree")
                    },
                    zoom: {
                        icon: c.a.zoom,
                        localizedName: Object(i.t)("Zoom In")
                    },
                    "zoom-out": {
                        icon: c.a["zoom-out"],
                        localizedName: Object(i.t)("Zoom Out")
                    }
                };
            Object(n.isFeatureEnabled)("remove-line-tool-ghost-feed") || (L.LineToolGhostFeed = {
        ...
        b2d7: function(o, e, l) {
            ...
            ! function(o) {
                ...
                o.favorites = [], o.favoritesSynced = new t.a, o.favoriteIndex = function(e) {
                    return o.favorites.indexOf(e)
                }, o.isValidLineToolName = l, o.saveFavorites = function(e) {
                    Object(c.setJSON)("chart.favoriteDrawings", o.favorites, e)
                }, e(), c.onSync.subscribe(null, e)
            }(i || (i = {})),
            function(o) {
                function e(o) {
                ...
                o.favoriteAdded = new t.a, o.favoriteRemoved = new t.a, o.favoriteMoved = new t.a, o.favoritesSynced = i.favoritesSynced, o.favorites = function() {
                ...
                }, o.isFavorite = n, o.moveFavorite = function(n, a, t) {
                    if (a < 0 || a >= l() || !e(n)) return !1;
                    const c = i.favoriteIndex(n);
                    return -1 !== c && a !== c && (i.favorites.splice(c, 1), i.favorites.splice(a, 0, n), i.saveFavorites(t), o.favoriteMoved.fire(n, c, a), !0)
                }
            }(n || (n = {}))
        },
        fEjm: function(o, e, l) {
