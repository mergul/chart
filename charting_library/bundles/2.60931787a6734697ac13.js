    ...
    [2], {
        ...
        WXjp: function(t, e, i) {
            ...
            class d extends s.PureComponent {
                constructor() {
                    super(...arguments), this._manager = new r.a, this._handleSlot = t => {
                ...
                render() {
                    const {
                        ...
                        className: r,
                        backdrop: d
                    } = this.props, c = n(r, l.dialog, t && l.rounded, e && l.shadowed, i && l.fullscreen, o && l.darker), u = Object(h.b)(this.props), p = this.props.style ? { ...this._createStyles(),
                        ...this.props.style
                    } : this._createStyles();
                    return s.createElement(s.Fragment, null, s.createElement(a.b.Provider, {
                        value: this._manager
                        ...
                        tabIndex: -1
                    }, this.props.children)), s.createElement(a.a, {
            ...
            class y {
                constructor(t, e = {
                    ...
                    }, this._dialog = t, this._options = e, this._initialHeight = t.style.height, window.addEventListener("resize", this._handleResize)
                }
                updateOptions(t = {
                    vertical: 0
                }) {
                ...
                centerAndFit() {
                    ...
                    i === s && (this._dialog.style.height = s + "px"), this._dialog.style.top = "0px", this._dialog.style.left = "0px", this._dialog.style.transform = `translate(${t}px, ${e}px)`
                }
                getDialogsTopLeftCoordinates() {
                    const {
                        clientHeight: t,
                        clientWidth: e
                    } = document.documentElement, i = this._calcDialogHeight(), s = e / 2 - this._dialog.clientWidth / 2, n = t / 2 - i / 2;
                    return {
                        x: Math.round(s),
                        y: Math.round(n)
                    }
                ...
                recalculateBounds() {
                    ...
                    if (this._isFullscreen) this._dialog.style.top = "0px", this._dialog.style.left = "0px", this._dialog.style.width = e + "px", this._dialog.style.height = t + "px", this._dialog.style.transform = "none";
                    else {
                        const {
                            vertical: i
                        } = this._options;
                        ...
                        this._dialog.style.top = "0px", this._dialog.style.left = "0px",
                            this._dialog.style.transform = `translate(${Math.round(o)}px, ${Math.round(a)}px)`, this._dialog.style.height = n < s.height ? n + "px" : this._initialHeight
                    }
                }
                destroy() {
            ...
            class D extends s.PureComponent {
                ...
                render() {
                    return s.createElement(x.a.Provider, {
                        value: this
                    }, s.createElement(u.a, {
                        mouseDown: !0,
                        touchStart: !0,
                ...
                _applyAppearanceAnimation(t) {
                    if (this._resize && this._dialog) {
                        ...
                        this._dialog.style.setProperty("--animationTranslateStartX", e + "px"), this._dialog.style.setProperty("--animationTranslateStartY", i + "px"), this._dialog.style.setProperty("--animationTranslateEndX", s + "px"), this._dialog.style.setProperty("--animationTranslateEndY", n + "px"), this._dialog.classList.add(w.dialogAnimatedAppearance)
                    }
                }
                _handleTooltipFit() {
                    0
            ...
            D.contextType = E.b, D.defaultProps = {
                boundByScreen: !0,
                draggable: !0,
                centeredOnMount: !0
            };
            ...
            function o(t) {
                return class extends s.PureComponent {
                    render() {
                        ...
                        if (!e) return null;
                        const o = s.createElement(t, { ...this.props,
                            zIndex: 150
                        });
