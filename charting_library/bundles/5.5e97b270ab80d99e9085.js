    ...
    [5], {
        ...
        DTHj: function(e, t, n) {
            ...
            class g extends s.a.PureComponent {
                constructor(e) {
                    super(e), this._containerRef = null, this._scrollWrapRef = null, this._raf = null, this._manager = new d.a, this._hotkeys = null, this._scroll = 0, this._handleContainerRef = e => {
                        ...
                        const {
                            position: t
                        } = this.props, n = Object(a.ensureNotNull)(this._containerRef);
                        ...
                        const u = r.height > o;
                        if (u) {
                            Object(a.ensureNotNull)(this._scrollWrapRef).style.overflowY = "scroll", r = n.getBoundingClientRect()
                        }
                        const {
                            width: c,
                            height: h
                        } = r, d = "function" == typeof t ? t(c, h) : t, p = i - (d.overrideWidth || c) - 0, m = Object(l.clamp)(d.x, 0, Math.max(0, p)), f = s - (d.overrideHeight || h) - 0;
                        let _ = Object(l.clamp)(d.y, 0, Math.max(0, f));
                        d.forbidCorrectYCoord && _ < d.y && (o -= d.y - _, _ = d.y), this.setState({
                        ...
                        if (null !== e && t.contains(e)) try {
                            e.scrollIntoView()
                        } catch (e) {} else Object(a.ensureNotNull)(this._scrollWrapRef).scrollTop = this._scroll
                    }, this._resize = () => {
                ...
                render() {
                    ...
                    return s.a.createElement(f.a.Provider, {
                        value: this
                    }, s.a.createElement(m.b, null, s.a.createElement(c.b.Provider, {
                        value: this._manager
            ...
            function y(e) {
                ...
                return s.a.createElement("div", {
                    ...
                    onMouseOver: function(e) {
                        if (!(null !== t.current && e.target instanceof Node && (r = e.target, null === (s = n.current) || void 0 === s ? void 0 : s.contains(r)))) return;
                        var r, s;
        ...
        dxYz: function(e, t, n) {
            ...
            function o(e) {
                const [t, n] = Object(r.useState)(null), o = Object(r.useRef)(null), a = Object(r.useRef)(new Map);
                return Object(r.useEffect)(() => () => {
                    null !== o.current && clearTimeout(o.current)
                }, []), s.a.createElement(i.Provider, {
                    value: {
                        current: t,
