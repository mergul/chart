        ...
        MB0Y: function(e, t, a) {
            ...
            class c extends n.PureComponent {
                render() {
                    const {
                        ...
                        intent: a,
                        ...i
                    } = this.props, o = s(l.input, -1 !== this.props.tabIndex && l.focus);
                    return n.createElement("div", {
                        className: r(this.props)
                    }, n.createElement("input", { ...i,
                        type: "checkbox",
                        className: o,
                        ref: e
                    }), n.createElement("div", {
            ...
            function m(e) {
                const {
                    ...
                    theme: p = d,
                    disabled: b
                } = e, g = o()(p.label, a && !u && p.labelOn), S = o()(t, p.wrapper, a && p.wrapperWithOnLabel);
        ...
        miV2: function(e, t, a) {
            ...
            class C extends i.PureComponent {
                ...
                render() {
                    const {
                        ...
                        isDisabled: l,
                        className: r
                    } = this.props, c = Object(S.b)(this.props);
                    return i.createElement(g.b, { ...c,
                        icon: s,
                        text: n,
                        title: a,
                        isDisabled: l,
            ...
            class N extends i.PureComponent {
                constructor(e, t) {
                    ...
                    } = t, s = a.activeChartStyle.value(), l = i.get();
                ...
                render() {
                    ...
                    } = this.state, m = "small" !== t && e && 0 !== s.length, v = [...s];
            ...
            class W extends i.PureComponent {
                ...
                render() {
                    ...
                    return i.createElement(j, { ...this.props,
                        icon: H,
                        isOpened: e,
                        onClick: this._handleClick,
                        text: z.compare,
            ...
            class le extends s.a.PureComponent {
                constructor(e, t) {
                    super(e, t), this._promise = null, this._menu = s.a.createRef(), this._setActiveState = e => {
                        ...
                        } = this.context, t = [...Object(K.ensureDefined)(e).favorites()];
                        this.setState({
                            favorites: t
                        }), this._clearCache()
            ...
            function ye(e) {
                const {
                    ...
                    onClickFavorite: m,
                    isSmallTablet: p
                } = e, b = Object(S.b)(e), [g, w] = Object(Ce.c)(), C = s.a.useCallback(() => u(t), [u, t]), f = s.a.useCallback(() => m(t), [m, t]), _ = Object(i.useRef)(null);
                return Object(i.useEffect)(() => {
                    var e;
                    r && p && (null === (e = _.current) || void 0 === e || e.scrollIntoView())
                }, [r, p]), s.a.createElement("div", { ...w,
                    ref: _
                }, s.a.createElement(d.b, { ...b,
            ...
            const Ie = {
                ...
                Fe = new Me.a,
                He = s.a.lazy(async () => ({
                    default: (await Promise.all([a.e(3), a.e(8), a.e(9), a.e(16), a.e(17), a.e(22), a.e(35), a.e(92), a.e(2), a.e(15), a.e(31), a.e("custom-intervals-add-dialog")]).then(a.bind(null, "w9vS"))).ToolWidgetIntervalsAddDialog
                }));
            ...
            class Le extends s.a.PureComponent {
                ...
                render() {
                    ...
                    } = this.state, l = this._getQuicks(), r = Object(he.sortResolutions)([...l]);
                ...
                _renderPopupMenuItem(e, t) {
                    const {
                        ...
                        activeInterval: n,
                        lastAddedInterval: i
                    } = this.state, o = e === n, l = Object(he.isAvailable)(e), r = this._isIntervalFavorite(e), c = this._isIntervalDefault(e), h = Object(he.getTranslatedResolutionModel)(e);
            ...
            class Ge extends i.PureComponent {
                ...
                render() {
                    return i.createElement(D.a, { ...this.props,
                        icon: Be,
                        title: Ke.hint,
                        onClick: this._handleClick
                    })
            ...
            class nt extends i.PureComponent {
                ...
                render() {
                    const {
                        ...
                        state: r,
                        isHovered: c = !1
                    } = this.props, h = m(Ze.container, s, c && Ze.hovered, {
            ...
            class gt extends i.PureComponent {
                ...
                _renderMenuItems(e) {
                    const {
                        ...
                        isSharingEnabled: b,
                        onSharingChanged: g
                    } = this.props, S = e ? k.a : mt, w = e ? void 0 : Object(qe.humanReadableHash)(qe.Modifiers.Mod + 83), C = e ? void 0 : Object(R.t)("Dot", {
                        context: "hotkey"
                    }), _ = [];
            ...
            const Mt = async function(e) {
                const t = URL.createObjectURL(new Blob([`<!doctype html><html style="background-color:${getComputedStyle(document.documentElement).backgroundColor}"><head><meta charset="utf-8"><title>${Ot}</title></head><body style="background-color:${getComputedStyle(document.body).backgroundColor}"></body></html>`], {
                    type: "text/html"
                }));
                try {
                    const a = open(t);
            ...
            function Ut(e) {
                const {
                    serverSnapshot: t,
                    clientSnapshot: n
                } = e, [o, l] = Object(i.useState)(!1), [r, c] = Object(i.useState)(!1), [h, u] = Object(i.useState)(!1), v = Object(jt.a)(), p = Object(i.useCallback)(async () => {
                    var e;
                    const t = n(),
                ...
                }, [n]), b = Object(i.useCallback)(async () => {
                    const e = await n();
                    Object(Nt.a)(e.name + ".png", e.canvas.toDataURL())
                }, [n]), g = e => Mt(e.then(e => e.imageUrl)), S = Object(i.useCallback)(async (e = !1) => {
                    const a = t();
                    try {
                        if (e) await g(a);
                        else {
                ...
                }, [t]), w = Object(i.useCallback)(async () => {
                    u(!0);
            ...
            function Vt(e) {
                const [t, a] = Object(i.useState)(!1), n = Object(jt.a)(), o = Object(i.useCallback)(async () => {
            ...
            var Bt = a("koZ+");
            const Kt = (Qt = function(e) {
                return Object(Et.isOnMobileAppPage)("any") ? s.a.createElement(Vt, { ...e,
                    icon: Bt
                }) : s.a.createElement(u.a, {
            ...
            function da(e) {
                const {
                    ...
                    isTabletSmall: h
                } = e, [u, m] = Object(Ce.c)(), p = t.meta_info, b = p ? Object(na.b)(p.indicators) : void 0, g = h ? ra : la, S = h ? ha : ca, w = Object(i.useCallback)(() => a(t), [a, t]), C = Object(i.useCallback)(() => n(t), [n, t]), f = Object(i.useCallback)(() => {
                    o && o(t)
                }, [o, t]);
            ...
            function fa(e) {
                const {
                    ...
                    isTabletSmall: c,
                    isLoading: h
                } = e, d = Object(i.useMemo)(() => t.filter(e => e.is_default), [t]), u = Object(i.useMemo)(() => t.filter(e => !e.is_default), [t]), m = Object(i.useMemo)(() => new Set(a.map(e => e.name)), [a]), p = Object(i.useContext)(wa), b = Object(i.useContext)(Sa.a), g = Object(ga.a)();
                Object(i.useEffect)(() => {
                    if (null !== p) {
                        const e = {};
            ...
            class Ra extends s.a.PureComponent {
                constructor(e, t) {
                    ...
                    this._model = new Ea(n, a), this.state = { ...this._model.state().value(),
                        isActive: !1
                    }
                }
                componentDidMount() {
            ...
            function Ia(e) {
                const {
                    ...
                    [Ma.full]: "full" === n,
                    [Ma.medium]: "medium" === n
                }), p = o.filter(e => i.includes(e.name)), g = "small" !== n && h && p.length > 0;
                return s.a.createElement(b, {
                    id: t,
                    className: m
                }, s.a.createElement(_.a, {
