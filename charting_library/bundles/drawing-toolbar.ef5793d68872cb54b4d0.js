        ...
        "5f7t": function(e, t, o) {
            ...
            class z extends i.PureComponent {
                constructor(e) {
                    super(e), this._toggleDropdown = e => {
                        ...
                        if (d.mobiletouch && !this.props.checkable) !this._longPressDelay && this.props.onClickButton && this.props.onClickButton();
                        else {
                ...
                render() {
                    const {
                        ...
                        isOpened: b
                    } = this.state, g = Object(x.b)(this.props);
            ...
            class q extends i.Component {
                constructor(e) {
                    super(e), this._renderItem = (e, t) => {
                        const {
                            isSmallTablet: o
                        } = this.props, n = c()(H.item, o && H.smallTablet, t && o && this.state.isActive && e === this.state.current && H.active);
                        return i.createElement("div", {
                            className: n,
                            key: e,
                            onClick: () => {
                        ...
                        Object(W.saveDefaults)("linetoolicon", { ...Object(W.defaults)("linetoolicon"),
                            icon: e
                        }), m.iconTool.setValue(e), m.tool.setValue("LineToolIcon");
                        let {
                            recents: t
                        } = this.state;
                        const o = t.indexOf(e); - 1 !== o && t.splice(o, 1), t = [e, ...t.slice(0, 9)],
                            Object(h.setJSON)("linetoolicon.recenticons", t), this.setState({
                                current: e,
                                recents: t
                            })
                    }, this.state = {
                ...
                render() {
                    const {
                        ...
                        isActive: s,
                        recents: a
                    } = this.state, l = Object(x.b)(this.props), r = c()(H.wrap, o && H.smallTablet);
                    return i.createElement(z, {
                        ...
                        ...l
                    }, a && i.createElement(i.Fragment, null, o && i.createElement("div", {
                        className: H.title
            ...
            class oe extends i.PureComponent {
                ...
                render() {
                    const {
                        ...
                        favState: l,
                        isActive: r
                    } = this.state, c = this._getCurrentToolName(), d = w.a[c], h = this._showShortcuts(), u = Object(x.b)(this.props);
                    return i.createElement("span", null, i.createElement(z, {
                        buttonIcon: d.icon,
            ...
            function de(e) {
                const {
                    ...
                    isSmallTablet: s
                } = e, [a, r] = Object(i.useState)(() => h.getValue("ChartToolsHideMode", "drawings")), [c, d] = Object(i.useState)(() => t.value()), [u, m] = Object(i.useState)(() => o.value());
                Object(i.useEffect)(() => {
            ...
            class Ke {
                constructor(e, t) {
                    this._component = null, this._handleRef = e => {
                        this._component = e
                    }, this._container = e, s.render(i.createElement(He, { ...t,
                        ref: this._handleRef
                    }), this._container)
                }
                destroy() {
        ...
        Sn4D: function(e, t, o) {
            ...
            function p(e) {
                const {
                    ...
                    className: b,
                    theme: g = m
                } = e, v = Object(s.ensureNotNull)(Object(i.useContext)(d.a)), [_, w] = Object(i.useState)(0), T = Object(i.useRef)(null), C = Object(i.useContext)(u.a);
