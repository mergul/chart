(window.webpackJsonp = window.webpackJsonp || []).push([
    [25], {
        ...
        "952j": function(e, t, n) {
            ...
            var r = n("Kxc7"),
                a = n("1pWb");
            const o = r.enabled("charting_library_base") ? /(?:[^-+\/*^\s]'|[a-zA-Z0-9_\u0370-\u1FFF_\u2E80-\uFFFF^])(?:[^-+\/*^\s]'|[a-zA-Z0-9_\u0020\u0370-\u1FFF_\u2E80-\uFFFF_!:.&])*|'.+?'/ : /(?:[^-+\/*^\s]'|[a-zA-Z0-9_\u0370-\u1FFF_\u2E80-\uFFFF])(?:[^-+\/*^\s]'|[a-zA-Z0-9_\u0020\u0370-\u1FFF_\u2E80-\uFFFF_!|:.&])*|'.+?'/,
                c = /[+\-/*]/,
                s = {
        ...
        SAe1: function(e, t, n) {
            ...
            class c extends r.Component {
                ...
                shouldComponentUpdate(e, t) {
                    return !o()(e, this.props) || (!o()(t.rules, this.state.rules) || !o()(t.matches, this.state.matches))
                }
                componentDidMount() {
            ...
            function c(e) {
                ...
                e.fromQuotesResponse = function(e) {
                ...
                }, e.fromQuotes = t, e.fromSymbolSearchResult = function(e, t) {
                    {
                        ...
                        return o.enabled("pay_attention_to_ticker_not_symbol") ? Object(a.ensureDefined)(null != n ? n : r) : Object(a.ensureDefined)(r)
                    }
        ...
        "rC+j": function(e, t, n) {
                    ...
                    for (let a = 0; a < e.length; a++) {
                        ...
                        if ("whitespace" !== o.type) switch (n) {
                            ...
                            case 2:
                                ...
                                break;
                            case 3:
                                "openBrace" === o.type ? r++ : "closeBrace" === o.type && (r--, r <= 0 && (n = 2))
                        }
                    }
                    return e.slice(t)
                }(e);
            ...
            function i(e) {
                return e.reduce((e, t) => "symbol" === t.type && a.a.test(t.value) ? e + `'${t.value}'` : e + t.value, "")
            }
            ...
            function d(e) {
                ...
                for (let a = 0; a < e.length; a++) {
                    ...
                    switch (o.type) {
                        ...
                        case "divide":
                        case "power":
                            n.length && n[n.length - 1].minPrecedence > o.precedence && (n[n.length - 1].minPrecedence = o.precedence);
                            break;
                        case "openBrace":
                            r = {
                                minPrecedence: 1 / 0,
            ...
            function b(e, t) {
                const {
                    ...
                    for (let n = 0; n < e.length; n++) {
                        const r = e[n],
                            a = "symbol" === r.type || "incompleteSymbol" === r.type || "number" === r.type;
        ...
        uTDg: function(e, t, n) {
            ...
            function w(e) {
                const {
                    ...
                    onClick: p,
                    queryString: m
                } = e, f = Object(r.useMemo)(() => Object(O.a)(m), [m]), b = i && !u, v = c()(N.container, d ? N.mobile : N.desktop, l && N.selected, u && N.allExchange, u && N.libAllExchange, !u && d && N.bordered);
                return a.a.createElement("div", {
            ...
            function D(e) {
                ...
                }) === j.a.Dark ? R : M, [m, y] = Object(r.useState)(""), x = Object(r.useCallback)(e => e.name.toLowerCase().includes(m.toLowerCase()) || e.desc.toLowerCase().includes(m.toLowerCase()), [m]), O = Object(r.useMemo)(() => [
                    [...t]
                ], [t]), k = Object(r.useMemo)(() => {
                    const e = O.filter(e => e.some(x));
                    return e
                }, [O, x]), N = Object(f.ensureNotNull)(n).value, D = Object(r.useRef)(null), A = Object(r.useRef)(null);
                Object(r.useLayoutEffect)(() => {
                    var e;
                    d && (null === (e = null == D ? void 0 : D.current) || void 0 === e || e.focus())
                }, []);
                ...
                return a.a.createElement(I.a.Provider, {
                    ...
                    return a.a.createElement(a.a.Fragment, {
                        ...
                        className: c()(_.exchangeItemsContainer, !l && _.exchangeItemsContainerDesktop)
                    }, e.filter(x).map(e => {
                        ...
                        return a.a.createElement(w, {
                            ...
                            title: t ? Object(s.t)("All sources") : e.name,
                            description: e.desc,
                            isActive: e.value === N,
                            isAllExchanges: t,
                            isMobile: l,
            ...
            function(e) {
                e[e.LogOut = 0] = "LogOut", e[e.FailedRestoring = 1] = "FailedRestoring", e[e.Offline = 2] = "Offline", e[e.APIError = 3] = "APIError", e[e.TwoFactorRequired = 4] = "TwoFactorRequired"
            }(K || (K = {}));
            n("EBrf"), n("ogJP");
            var H = n("txPx");
            n("25b6");
            ...
            function le(e) {
                ...
                const {
                    ...
                    forceUpdate: s,
                    upperCaseEnabled: u
                } = Object(f.ensureNotNull)(Object(r.useContext)(b.a)), p = Object(i.b)(null === (t = c.current) || void 0 === t ? void 0 : t.value), m = Object(l.h)(p);
                let h = [{
                    icon: ne,
                    insert: "/",
                    type: "binaryOp",
                ...
                return d.enabled("hide_exponentiation_spread_operator") || (h = h.concat([{
                    ...
                    d.enabled("hide_reciprocal_spread_operator") || (h = h.concat([{
                        ...
                        name: "1/x",
                        callback: () => {
                            !c.current || m.errors.length || m.warnings.length || (c.current.value = Object(l.g)(Object(l.a)(p)), s())
                        }
                    }])), a.a.createElement("div", {
                        ...
                        onClick: () => function(e) {
                            ...
                            if (!ue(e, m)) {
                                if (e.insert && c.current) {
                                    ...
                                    c.current.value = t, c.current.setSelectionRange(t.length, t.length);
                                    const [r, , a] = Object(l.b)(c.current, u);
                                    n.current && (n.current.selectedIndexValue = -1, n.current.searchSpreadsValue = Object(l.e)(a), n.current.searchTokenValue = r), s(), o()
                                }
                                e.callback && e.callback(), null === (t = c.current) || void 0 === t || t.focus(), Object(J.trackEvent)("GUI", "SS", e.name)
                            }
                        }(e)
                    })))
            }
            ...
            function me(e) {
                ...
                return c()(pe.bubble, t && pe.active, r && pe[r], a && pe["size-" + a], o && pe["appearance-" + o], n && pe.animated, s)
            }
            ...
            function fe(e) {
                ...
                return a.a.createElement("span", { ...Object(de.a)(d),
                    ...Object(de.b)(d),
                    id: t,
                    title: n,
                    tabIndex: r,
            ...
            function ke(e) {
                const {
                    ...
                    selectedExchange: l,
                    upperCaseEnabled: u
                } = Object(f.ensureNotNull)(Object(r.useContext)(b.a)), d = Object(f.ensureNotNull)(l), p = "symbolSearch" === t, m = Object(g.g)(d), {
                    country: v,
                    providerId: y,
                    flag: E
                } = d;
            ...
            function Se(e) {
                const {
                    isSmallWidth: t,
                    selectedExchange: n
                } = Object(f.ensureNotNull)(Object(r.useContext)(b.a)), o = n && we.length > 1 && !Object(g.a)();
                return a.a.createElement("div", {
                    ...
                    className: Ne.text
                }, t ? Object(s.t)("Symbol & description") : Object(s.t)("Symbol"))), a.a.createElement("div", {
                    className: Ne.item
            ...
            function je(e) {
                ...
                }, [l]), E = Object(r.useCallback)(e => Object(f.ensure)(l[e].key), [l]), x = "watchlist" === p && null !== v;
            ...
            function Me(e) {
                const {
                    ...
                    checked: u,
                    onCheckboxChange: d
                }), N = "symbolSearch" === f && "good" === n, w = null != x ? x : Ie.a, S = Object(r.useMemo)(() => E.map(e => a.a.createElement(w, { ...e,
                    searchToken: t
                })), [E]);
                return a.a.createElement(a.a.Fragment, null, "symbolSearch" === f && a.a.createElement(a.a.Fragment, null, y.length > 0 && a.a.createElement(be, {
                ...
                }, a.a.createElement(ve.a, null)), "symbolSearch" === f && a.a.createElement(a.a.Fragment, null, !1, "empty" === n && a.a.createElement(O, null)))
            }
            ...
            function Ae(e) {
                ...
                Object(r.useEffect)(() => {
                    ...
                    const e = y.current;
                    if (e) return e.addEventListener("input", be), e.addEventListener("focus", Ee), e.addEventListener("select", he), e.addEventListener("click", he), e.addEventListener("keyup", xe), _ && L && e.addEventListener("keydown", L), () => {
                        e && (e.removeEventListener("input", be), e.removeEventListener("focus", Ee), e.removeEventListener("select", he), e.removeEventListener("click", he), e.removeEventListener("keyup", xe), _ && L && e.removeEventListener("keydown", L))
                    }
                }, [L]), Object(r.useEffect)(() => {
                    Boolean(T) && "" === F.trim() || (ge(F, m, null == u ? void 0 : u.value), W.current && (W.current.scrollTop = 0))
                }, [F, m, u, oe, T]), Object(r.useEffect)(() => {
                    if (!k || !y.current) return;
                    if (!d.enabled("show_spread_operators")) return y.current.value = k.symbol, void w();
                ...
                async function ge(e, t, n) {
                    try {
                        ...
                        const r = await async function(e, t, n, r) {
                                var a, o, c;
                                const s = d.enabled("show_spread_operators") ? Object(l.f)(t) : null === (a = y.current) || void 0 === a ? void 0 : a.value;
                                let i;
                                if (oe && ne) {
                                    const t = await Object(q.b)(e, ne.accountMetainfo());
                                    i = t.prefix
                                }
                                const p = d.enabled("show_spread_operators") ? null !== (c = null !== (o = Object(l.c)(t)) && void 0 !== o ? o : i) && void 0 !== c ? c : r : null == u ? void 0 : u.value,
                                    m = {
                                        serverHighlight: !1,
                                        text: s,
                                        exchange: p,
                                ...
                                return Y(m)
                            }(A.current.signal, e, t, n),
                            a = ie(function(e, t = window.ChartApiInstance.symbolsGrouping()) {
                                var n;
                                const r = {},
                                    a = [];
                                for (let o = 0; o < e.length; ++o) {
                                    ...
                                    if (i) {
                                        const e = i[1];
                                        let t;
                                        r.hasOwnProperty(e) ? t = r[e] : (t = a.length, r[e] = t, a.push({
                                            type: c.type,
                                            symbol: e,
                                            exchange: c.exchange,
                                            ...
                                            contracts: []
                                        })), null === (n = a[t].contracts) || void 0 === n || n.push(c)
                                    } else a.push(c)
                                }
                                return a
                            }(r));
                ...
                function Ee() {
                    "watchlist" === D.current && (n("symbolSearch"), Object(J.trackEvent)("Watchlist", "Mobile SS", "Go to SS page"))
                }
            ...
            function Ue(e) {
                ...
                const {
                    ...
                    onKeyDown: M,
                    exchangeScreen: _
                } = e, L = void 0 !== e.input, [A, z] = Object(r.useState)(o), P = Object(r.useRef)(c), [B, Z] = Ge({
                    exchanges: Qe,
                    defaultExchange: qe
                }), [V, F] = We({
                    types: C
                }), [G, W] = Object(r.useState)([]), [X, K] = Object(r.useState)(!1), [Q, q] = Object(r.useState)(-1), H = Object(r.useRef)(null !== (t = e.input) && void 0 !== t ? t : null), [$, J] = Object(r.useState)(!1), te = Object(Xe.a)(), [ne, re] = Object(r.useState)(new Set), {
                    broker: ae = null,
                    brokerId: oe,
                ...
                Object(r.useLayoutEffect)(() => {
                    var e;
                    !(null == H ? void 0 : H.current) || !L && Boolean(null === (e = H.current) || void 0 === e ? void 0 : e.value) || (L || "compare" === A || (H.current.value = P.current), !I || L && "symbolSearch" !== A || H.current.focus())
                ...
                Object(r.useEffect)(() => {
                    var e; - 1 !== Q && (null === (e = le.current) || void 0 === e || e.scrollIntoView({
                        block: "nearest"
                    }))
                }, [Q, le]);
                const ue = Object(r.useMemo)(() => ie.map((e, t) => {
                        ...
                        if (U(e)) {
                            ...
                            return {
                                ...
                                isOffset: !0,
                                isEod: null === (a = e.params) || void 0 === a ? void 0 : a.includes("eod"),
                                onClick: ye.bind(null, e.parent, e),
                                providerId: n.provider_id,
                                country: null === (o = n.country) || void 0 === o ? void 0 : o.toLowerCase(),
                                type: n.type,
                                ...
                                const t = ue[Q],
                                    {
                                        ...
                                        isOffset: r,
                                        onExpandClick: a
                                    } = t;!r && n && ne.has(n) && Boolean(a) && (e.preventDefault(), ge(n));
                                break
                            }
                        case 39:
                            {
                        ...
                        if (r && "" !== r.trim()) {
                            ...
                            if (void 0 !== oe && -1 === r.indexOf(":"))(function(e) {
                                ...
                                return Promise.all(e.map(e => -1 !== e.indexOf(":") || t ? Promise.resolve({
                                    ...
                                    var t;
                                    null === (t = await (null == ae ? void 0 : ae.accountMetainfo())) || void 0 === t || t.prefix;
                                    const n = await Y({
                                        strictMatch: !0,
                                        serverHighlight: !1,
                                        text: e,
                                    ...
                                    if (0 !== n.length) {
                                        ...
                                        if (a && o) return {
                                            symbol: Ve.a.fromSymbolSearchResult(e, r),
                                            resolved: !0,
                                            result: e
                                        }
                                    }
            ...
            function tt(e) {
                ...
                return a.a.createElement(m.a, { ...e,
        ...
        zjoO: function(e, t, n) {
            ...
            function g(e) {
                const {
                    ...
                    isSmallWidth: G,
                    isMobile: W
                } = Object(s.ensureNotNull)(Object(r.useContext)(d.a)), X = Boolean(M), K = !C && !j && (W || !X), Q = Object(m.a)({
                    watchedValue: f.watchedTheme
                }) === p.a.Dark ? v.dark : v.light, q = M;
                return a.a.createElement("div", {
                    className: c()(v.itemRow, G && v.multiLine, T && v.highlighted, T && Q, k && v.selected, w && v.active, C && v.invalid, !W && h.mobiletouch && X && v.hover, Z),
                    ...
                    className: c()(v.symbolTitle, w && v.active, C && v.invalid, !Boolean(o) && v.noDescription),
                    ...
                    className: v.dataMode
                }, "E")), G && H())), !G && H(), q ? a.a.createElement(q, { ...e,
                    className: v.cell,
                    onMouseOver: void 0,
                    onMouseOut: void 0
                ...
                function H() {
                    if (C) return null;
                    const e = c()(v.symbolDescription, !G && v.cell, w && v.active, !h.mobiletouch && "apply-overflow-tooltip apply-overflow-tooltip--allow-text");
