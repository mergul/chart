...
var csv_json = d3.csvParse(csv_string);
var time_format = d3.timeParse("%Y-%m-%d");
...
svg.append("path").datum(csv_json).attr("class", "line").attr("d", line);
...
var regression_line = d3
  ...
  .y(function (d) {
    var tmp = lr.intercept + lr.slope * d.occurred;
    return y(tmp);
  });
